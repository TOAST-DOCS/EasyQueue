...
> **[참고] 토픽의 메시지 정리 정책, 복제본 수, 최소 동기화 복제본 수 변경 불가** <br>

> **[참고] EasyQueue 토픽, 파티션 생성 개수 제한** <br>
...
2. 토픽 정보를 수정합니다. 수정 가능한 항목은 설명, 파티션 수, 메시지 최대 크기, 파티션당 최대 저장 크기, 메시지 저장 기간입니다.
    * 토픽의 파티션 수는 현재 파티션 수보다 작게 변경 불가합니다.
3. 설정을 변경한 후 **확인** 버튼을 클릭합니다.
...
2. 전송할 메시지 정보를 입력한 후 **확인** 버튼을 클릭합니다.
...
> **[참고] 토픽의 메시지 전송은 아무 값도 입력하지 않아도 전송 가능** <br>
